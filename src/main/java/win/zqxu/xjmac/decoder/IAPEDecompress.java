...
public abstract class IAPEDecompress {
  ...
  // int nBlocks
  // the number of audio blocks desired (see note at intro about blocks vs.
  ////////////////////////////////////////////////////////////////////////////////////////////// samples)
  // int * pBlocksRetrieved
  // the number of blocks actually retrieved (could be less at end of file or on
  ////////////////////////////////////////////////////////////////////////////////////////////// critical
  ////////////////////////////////////////////////////////////////////////////////////////////// failure)
  //////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public static IAPEDecompress CreateIAPEDecompressCore(APEInfo pAPEInfo, int nStartBlock,
      int nFinishBlock) {
  ...
  public static IAPEDecompress CreateIAPEDecompressEx(APEInfo pAPEInfo, int nStartBlock,
      int nFinishBlock) {
