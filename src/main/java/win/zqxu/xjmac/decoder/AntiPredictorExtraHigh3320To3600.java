...
public class AntiPredictorExtraHigh3320To3600 extends AntiPredictor {
  public void AntiPredict(int[] pInputArray, int[] pOutputArray, int NumberOfElements,
    ...
    for (int z = Iterations; z >= 0; z--) {
      AntiPredictorOffset(pInputArray, pOutputArray, NumberOfElements, (int) pOffsetValueArrayB[z],
          -1, 32);
      AntiPredictorOffset(pOutputArray, pInputArray, NumberOfElements, (int) pOffsetValueArrayA[z],
          1, 32);
    }
