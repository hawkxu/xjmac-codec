...
public class AntiPredictorHigh3700To3800 extends AntiPredictor {
  ...
  public void AntiPredict(int[] pInputArray, int[] pOutputArray, int NumberOfElements) {
    ...
    int p2 = pInputArray[FIRST_ELEMENT - 1]
        + ((pInputArray[FIRST_ELEMENT - 3] - pInputArray[FIRST_ELEMENT - 2]) << 3);
    ...
    for (; op < NumberOfElements; op++, ip++) {
      ...
      pInputArray[ip] = Original - (((pInputArray[ip - 1] * bm[0]) + (pInputArray[ip - 2] * bm[1])
          + (pInputArray[ip - 3] * bm[2]) + (pInputArray[ip - 4] * bm[3])
          + (pInputArray[ip - 5] * bm[4]) + (pInputArray[ip - 6] * bm[5])
          + (pInputArray[ip - 7] * bm[6]) + (pInputArray[ip - 8] * bm[7])
          + (pInputArray[ip - 9] * bm[8]) + (pInputArray[ip - 10] * bm[9])
          + (pInputArray[ip - 11] * bm[10]) + (pInputArray[ip - 12] * bm[11])
          + (pInputArray[ip - 13] * bm[12]) + (pInputArray[ip - 14] * bm[13])
          + (pInputArray[ip - 15] * bm[14]) + (pInputArray[ip - 16] * bm[15])) >> 8);
