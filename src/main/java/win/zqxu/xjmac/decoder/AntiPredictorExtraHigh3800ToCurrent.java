...
public class AntiPredictorExtraHigh3800ToCurrent extends AntiPredictor {
  ...
  public void AntiPredict(int[] pInputArray, int[] pOutputArray, int NumberOfElements,
    ...
    int p2 = pInputArray[nFirstElement - 1]
        + ((pInputArray[nFirstElement - 3] - pInputArray[nFirstElement - 2]) << 3);
    ...
    for (q = nFirstElement; op < NumberOfElements; op++, ip++, q++) {
      ...
      pInputArray[ip] -= (Helper.ConventionalDotProduct(IPShort, q - nFirstElement, bm, 0,
          IPAdaptFactor, q - nFirstElement, Original, nFilterStageElements) >> nFilterStageShift);
