...
public class WaveFormat {
  ...
  public static void FillWaveFormatEx(WaveFormat pWaveFormatEx, int nSampleRate, int nBitsPerSample,
      int nChannels) {
    ...
    pWaveFormatEx.nBlockAlign = (short) ((pWaveFormatEx.wBitsPerSample / 8)
