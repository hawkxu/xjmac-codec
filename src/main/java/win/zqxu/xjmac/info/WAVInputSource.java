...
/**
 * Author: Dmitry Vaguine Date: 07.05.2004 Time: 14:10:50
 */
public class WAVInputSource extends InputSource {
  // construction / destruction
  public WAVInputSource(File pIO, WaveFormat pwfeSource, IntegerPointer pTotalBlocks,
  ...
  public WAVInputSource(String pSourceName, WaveFormat pwfeSource, IntegerPointer pTotalBlocks,
      IntegerPointer pHeaderBytes, IntegerPointer pTerminatingBytes) throws IOException {
  ...
  private void AnalyzeSource() throws IOException {
    ...
    WaveFormat.FillWaveFormatEx(m_wfeSource, WAVFormatHeader.nSamplesPerSec,
        WAVFormatHeader.wBitsPerSample, WAVFormatHeader.nChannels);
