...
public class APEFileInfo {
  ...
  public int nTotalFrames; // the total number frames (frames are used
                           // internally)
  public int nBlocksPerFrame; // the samples in a frame (frames are used
                              // internally)
  ...
  public int nDecompressedBitrate; // the kbps of the decompressed audio (i.e.
                                   // 1440 kpbs for CD audio)
  ...
  public APEDescriptor spAPEDescriptor; // the descriptor (only with newer
                                        // files)
}
