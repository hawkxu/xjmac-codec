...
public class APEHeaderNew {
  ...
  public long nBlocksPerFrame; // the number of audio blocks in one frame
                               // (unsigned int)
  public long nFinalFrameBlocks; // the number of audio blocks in the final
                                 // frame (unsigned int)
  public long nTotalFrames; // the total number of frames (unsigned int)

  public int nBitsPerSample; // the bits per sample (typically 16) (unsigned
                             // short)
