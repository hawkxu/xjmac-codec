...
public class MD5 {
  ...
  /**
   * If Final() has been called, finals is set to the current finals state. Any
   * Update() causes this to be set to null.
   */
  MD5State finals;
  ...
  /**
   * Initialize MD5 internal state (object can be reused just by calling Init()
   * after every Final()
   */
  ...
  /*
   * I wonder how many loops and hoops you'll have to go through to get unsigned
   * add for longs in java
   */
  ...
  /*
   * Update()s for other datatypes than byte[] also. Update(byte[], int) is only
   * the main driver.
   */
