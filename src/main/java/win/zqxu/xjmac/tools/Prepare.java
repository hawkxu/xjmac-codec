...
public class Prepare {
  ...
  public void prepare(ByteArrayReader pRawData, int nBytes, final WaveFormat pWaveFormatEx,
      int[] pOutputX, int[] pOutputY, Crc32 pCRC, IntegerPointer pSpecialCodes,
  ...
  public void unprepare(int X, int Y, final WaveFormat waveFormat, final ByteBuffer output,
      final Crc32 crc) {
  ...
  public void unprepareOld(int[] pInputX, int[] pInputY, int nBlocks, WaveFormat pWaveFormatEx,
      ByteBuffer output, Crc32 crc, int nFileVersion) {
